...
<div id="screen-dashboard" class="screen">
  ...
  <div class="tabnav">
    ...
    <button class="tabtop" onclick="switchTab('equipes',this)">🗺️ Zones</button>
    ...
    <button class="tabtop" id="tab-btn-carto" onclick="switchTab('cartographie',this);initCarto();setTimeout(function(){if(cartoMap)cartoMap.invalidateSize();},300);setTimeout(function(){if(cartoMap)cartoMap.invalidateSize();},600)">🗺️ Cartographie</button>
  </div>
  ...
  <div class="page-content" style="padding-top:104px; max-width:960px; margin:0 auto; padding-left:14px; padding-right:14px; padding-bottom:60px;">
    ...
    <div class="tabcontent" id="tab-equipes">
      ...
      <div class="card" style="padding:0;overflow:hidden;margin-bottom:14px;">
        <div style="padding:10px 14px;background:linear-gradient(135deg,var(--c1),var(--c2));color:#fff;display:flex;align-items:center;justify-content:space-between;">
          <div style="font-size:13px;font-weight:700;">🗺️ Carte des zones — Fès &nbsp;<span style="font-size:10px;background:rgba(255,255,255,0.2);border-radius:20px;padding:2px 7px;font-family:'DM Sans',sans-serif;font-weight:600;">🔴 En direct</span></div>
          <button onclick="switchTab('cartographie',document.querySelector('[onclick*=cartographie]'));initCarto();setTimeout(function(){if(cartoMap)cartoMap.invalidateSize();},300);setTimeout(function(){if(cartoMap)cartoMap.invalidateSize();},600);" style="background:rgba(255,255,255,0.18);border:none;border-radius:8px;padding:4px 10px;font-size:11px;font-weight:700;color:#fff;cursor:pointer;">Agrandir →</button>
        </div>
        <!-- Légende compacte -->
        <div style="display:flex;gap:10px;flex-wrap:wrap;padding:7px 14px;background:var(--surface);border-bottom:1px solid var(--bo);font-size:11px;">
          <span style="display:flex;align-items:center;gap:4px;"><span style="width:10px;height:10px;border-radius:50%;background:#7B1111;display:inline-block;border:2px solid #fff;box-shadow:0 1px 3px rgba(0,0,0,.3);"></span>⛪ Église EEM</span>
          <span style="display:flex;align-items:center;gap:4px;"><span style="width:10px;height:10px;border-radius:2px;border:2px dashed #888;display:inline-block;"></span>Zone</span>
          <span style="display:flex;align-items:center;gap:4px;"><span style="width:10px;height:10px;border-radius:50%;background:#3498DB;display:inline-block;"></span>Évangéliste</span>
          <span style="display:flex;align-items:center;gap:4px;"><span style="width:10px;height:10px;border-radius:50%;background:#E74C3C;display:inline-block;"></span>Non confiée</span>
          <span style="display:flex;align-items:center;gap:4px;"><span style="width:10px;height:10px;border-radius:50%;background:#E67E22;display:inline-block;"></span>En cours</span>
          <span style="display:flex;align-items:center;gap:4px;"><span style="width:10px;height:10px;border-radius:50%;background:#27AE60;display:inline-block;"></span>Visitée</span>
        </div>
        <div id="zone-mini-map" style="height:320px;width:100%;"></div>
      </div>

      <div class="card" style="padding:16px;margin-bottom:14px;">
        <div class="chart-title" style="margin-bottom:4px;">Répartition par zone &amp; quartier</div>
        <p style="font-size:12px;color:var(--mu);margin-bottom:14px;">Les zones sont constituées automatiquement à partir des quartiers enregistrés dans les fiches visiteurs.</p>
    ...
    <!-- TAB CARTOGRAPHIE -->
    <div class="tabcontent" id="tab-cartographie">

      <div style="background:linear-gradient(135deg,var(--c1),var(--c2));border-radius:var(--r);padding:16px 18px;margin-bottom:14px;color:#fff;position:relative;overflow:hidden;">
        <div style="font-family:'Cormorant Garamond',serif;font-size:16px;font-weight:700;margin-bottom:10px;opacity:.95;">🗺️ Cartographie — Évangélisation Fès &nbsp;<span style="font-size:10px;background:rgba(255,255,255,0.2);border-radius:20px;padding:2px 8px;font-family:'DM Sans',sans-serif;font-weight:600;letter-spacing:.04em;vertical-align:middle;">🔴 En direct</span></div>
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:8px;">
          <div style="text-align:center;background:rgba(255,255,255,0.12);border-radius:10px;padding:10px 4px;">
            <div id="carto-nb-fiches" style="font-family:'Cormorant Garamond',serif;font-size:26px;font-weight:700;line-height:1;">—</div>
            <div style="font-size:9px;text-transform:uppercase;letter-spacing:.07em;opacity:.75;margin-top:2px;">Fiches</div>
          </div>
          <div style="text-align:center;background:rgba(255,255,255,0.12);border-radius:10px;padding:10px 4px;">
            <div id="carto-nb-quartiers" style="font-family:'Cormorant Garamond',serif;font-size:26px;font-weight:700;line-height:1;">—</div>
            <div style="font-size:9px;text-transform:uppercase;letter-spacing:.07em;opacity:.75;margin-top:2px;">Quartiers</div>
          </div>
          <div style="text-align:center;background:rgba(255,255,255,0.12);border-radius:10px;padding:10px 4px;">
            <div id="carto-nb-ev" style="font-family:'Cormorant Garamond',serif;font-size:26px;font-weight:700;line-height:1;">—</div>
            <div style="font-size:9px;text-transform:uppercase;letter-spacing:.07em;opacity:.75;margin-top:2px;">Évangélistes</div>
          </div>
          <div style="text-align:center;background:rgba(255,255,255,0.12);border-radius:10px;padding:10px 4px;">
            <div id="carto-nb-zones" style="font-family:'Cormorant Garamond',serif;font-size:26px;font-weight:700;line-height:1;">—</div>
            <div style="font-size:9px;text-transform:uppercase;letter-spacing:.07em;opacity:.75;margin-top:2px;">Zones</div>
          </div>
        </div>
        <div style="position:absolute;right:16px;top:50%;transform:translateY(-50%);font-size:72px;opacity:.05;pointer-events:none;">✝</div>
      </div>

      <!-- Filtres -->
      <div style="display:flex;gap:8px;margin-bottom:12px;flex-wrap:wrap;">
        <select id="carto-filter-zone" onchange="updateCartoMap()" class="toolbar-sel">
          <option value="">Toutes les zones</option>
        </select>
        <select id="carto-filter-ev" onchange="updateCartoMap()" class="toolbar-sel">
          <option value="">Tous les évangélistes</option>
        </select>
        <select id="carto-filter-statut" onchange="updateCartoMap()" class="toolbar-sel">
          <option value="">Tous statuts</option>
          <option value="nouveau">🆕 Non confiées</option>
          <option value="assigne">📋 En cours</option>
          <option value="visite">✅ Visitées</option>
        </select>
        <button class="btn btn-outline btn-sm" onclick="updateCartoMap()" style="white-space:nowrap;">🔄 Actualiser</button>
      </div>

      <!-- Légende -->
      <div style="display:flex;gap:10px;flex-wrap:wrap;margin-bottom:12px;padding:10px 14px;background:var(--surface);border:1px solid var(--bo);border-radius:var(--r-sm);">
        <div style="font-size:11px;font-weight:700;color:var(--mu);text-transform:uppercase;letter-spacing:.06em;align-self:center;">Légende :</div>
        <div style="display:flex;align-items:center;gap:5px;font-size:12px;"><span style="width:12px;height:12px;border-radius:50%;background:#7B1111;display:inline-block;border:2px solid #fff;box-shadow:0 1px 4px rgba(0,0,0,0.3);"></span>Église EEM</div>
        <div style="display:flex;align-items:center;gap:5px;font-size:12px;"><span style="width:12px;height:12px;border-radius:50%;background:#E74C3C;display:inline-block;"></span>Non confiée</div>
        <div style="display:flex;align-items:center;gap:5px;font-size:12px;"><span style="width:12px;height:12px;border-radius:50%;background:#E67E22;display:inline-block;"></span>En cours</div>
        <div style="display:flex;align-items:center;gap:5px;font-size:12px;"><span style="width:12px;height:12px;border-radius:50%;background:#27AE60;display:inline-block;"></span>Visitée</div>
        <div style="display:flex;align-items:center;gap:5px;font-size:12px;"><span style="width:12px;height:12px;border-radius:50%;background:#3498DB;display:inline-block;"></span>Évangéliste</div>
      </div>

      <!-- Carte -->
      <div class="card" style="padding:0;overflow:hidden;margin-bottom:14px;">
        <div id="carto-map" style="height:420px;width:100%;border-radius:var(--r);"></div>
      </div>

      <!-- Tableau quartiers -->
      <div class="card" style="margin-bottom:14px;">
        <div class="card-header">
          <div class="card-title">Répartition par quartier</div>
          <div id="carto-total-label" style="font-size:11px;color:var(--mu);"></div>
        </div>
        <div id="carto-quartier-list" style="padding:0;">
          <div class="empty-state"><div class="ico">⏳</div><p>Chargement…</p></div>
        </div>
      </div>
      ...
      <div class="card" style="margin-bottom:14px;">
        <div class="card-header">
          <div class="card-title">Couverture par évangéliste</div>
        </div>
        <div id="carto-ev-list" style="padding:0;">
          <div class="empty-state"><div class="ico">⏳</div><p>Chargement…</p></div>
        </div>
      </div>

    </div><!-- /tab-cartographie -->
...
/* ═══════════════════════════════════════════════════════════
   CARTOGRAPHIE — Module Fès
═══════════════════════════════════════════════════════════ */

var QUARTIER_COORDS = {
  /* ── Ville Nouvelle / Centre ── */
  'saiss':             [34.0209, -5.0003],
  'agdal':             [34.0350, -5.0030],
  'ville nouvelle':    [34.0210, -5.0030],
  'hay riad':          [34.0200, -5.0200],
  'dokkarat':          [34.0400, -5.0080],
  'les orangers':      [34.0460, -5.0020],
  'sidi brahim':       [34.0390, -4.9960],
  'oued fes':          [34.0300, -5.0080],
  'montfleuri':        [34.0290, -5.0150],
  'mont fleuri':       [34.0290, -5.0150],
  /* ── Nord / Université ── */
  'bensouda':          [34.0450, -5.0150],
  'ain chkef':         [34.0530, -5.0050],
  'ain-chkef':         [34.0530, -5.0050],
  'route imouzzer':    [34.0550, -5.0200],
  'dhar el mehrez':    [34.0480, -4.9900],
  'zouagha':           [34.0520, -4.9950],
  /* ── Atlas / Narjiss ── */
  'atlas':             [34.0280, -4.9900],
  'narjiss':           [34.0290, -5.0100],
  /* ── Médina / Fès el Bali ── */
  'medina':            [34.0647, -4.9785],
  'médina':            [34.0647, -4.9785],
  'fes el bali':       [34.0647, -4.9785],
  'borj nord':         [34.0680, -4.9850],
  'ain kadous':        [34.0620, -4.9800],
  'boujloud':          [34.0630, -4.9830],
  /* ── Zones campus ── */
  'euromed':           [34.0173, -5.0425],
  'ueuromed':          [34.0173, -5.0425],
  'université euromed':[34.0173, -5.0425],
  'sebaa rouadi':      [34.0120, -4.9790],
  'sebaa':             [34.0120, -4.9790],
  'chaima':            [34.0068, -5.0012],
  'lido':              [34.0060, -5.0180],
  /* ── Autres quartiers Fès ── */
  'ait seghrouchen':   [34.0240, -4.9750],
  'sefrou':            [33.8300, -4.8340],
  'ain bida':          [34.0380, -5.0310],
  'bd kennedy':        [34.0200, -5.0100],
  'boulevard kennedy': [34.0200, -5.0100],
  'hassan ii':         [34.0230, -5.0050],
  'av hassan ii':      [34.0230, -5.0050],
  'avenue hassan ii':  [34.0230, -5.0050],
  'fes':               [34.0209, -5.0003],
  'fès':               [34.0209, -5.0003],
  'centre ville':      [34.0210, -5.0030],
  'centre':            [34.0210, -5.0030],
  'marjane':           [34.0350, -5.0150],
  'aouinet hajjaj':    [34.0380, -4.9980],
  'hay sadri':         [34.0430, -5.0100],
  'sidi harazem':      [34.0100, -4.9500],
  'ain cheggag':       [33.9800, -4.9600],
  'route sefrou':      [34.0000, -4.9900],
  'oued zboun':        [34.0500, -5.0050],
  'bab ftouh':         [34.0600, -4.9830],
  'bab guissa':        [34.0680, -4.9780],
  'bab jdid':          [34.0600, -4.9890],
  'dar dbibegh':       [34.0610, -4.9870],
  'andalous':          [34.0640, -4.9760],
  'kariat':            [34.0150, -5.0050],
  'queens':            [34.0173, -5.0425],
  'ueuromed':          [34.0173, -5.0425],
  'campus':            [34.0173, -5.0425],
  'hay mohammadi':     [34.0350, -5.0200],
  'hay hassani':       [34.0370, -5.0180],
  'ryad':              [34.0380, -5.0250],
  'ain nokbi':         [34.0460, -4.9800],
  'jnan el ward':      [34.0400, -5.0300],
};

/* ──────────────────────────────────────────────
   ZONES DE FÈS — coordonnées centre + rayon (m)
   Couleurs alignées sur ZONE_COLORS du kanban
────────────────────────────────────────────── */
var ZONE_MAP_DEFS = [
  { nom: 'Euromed',       center: [34.0173,-5.0425], radius: 900,  color: '#1E50C8', icon: '🎓' },
  { nom: 'Sebaa Rouadi',  center: [34.0120,-4.9790], radius: 700,  color: '#823C00', icon: '🏘️' },
  { nom: 'Chaima',        center: [34.0068,-5.0012], radius: 650,  color: '#1A7A3A', icon: '🏘️' },
  { nom: 'Bensouda',      center: [34.0450,-5.0150], radius: 800,  color: '#7B1111', icon: '🏘️' },
  { nom: 'Lido',          center: [34.0060,-5.0180], radius: 600,  color: '#501EA0', icon: '🏘️' },
  { nom: 'Atlas',         center: [34.0280,-4.9900], radius: 750,  color: '#007878', icon: '⛰️' },
  { nom: 'Mont Fleuri',   center: [34.0290,-5.0150], radius: 700,  color: '#B45000', icon: '🌿' },
  { nom: 'Narjiss',       center: [34.0290,-5.0100], radius: 650,  color: '#555555', icon: '🏘️' },
];

var CHURCH_POINTS = [
  {
    lat: 34.02188, lng: -5.00148,
    label: 'Église EEM — Café Assouan',
    desc: 'Point de rassemblement — Av. Hassan II, Fès',
    icon: '⛪', color: '#7B1111', fixed: true
  }
];

/* ── helpers ── */
function _normalizeQ(s) {
  return (s || '').toLowerCase().trim()
    .normalize('NFD').replace(/[̀-ͯ]/g, '')
    .replace(/[-_]/g, ' ').replace(/\s+/g, ' ');
}
function _qCoords(quartier) {
  if (!quartier) return null;
  var q = _normalizeQ(quartier);
  // Recherche exacte normalisée
  for (var k in QUARTIER_COORDS) {
    if (_normalizeQ(k) === q) return QUARTIER_COORDS[k];
  }
  // Recherche partielle normalisée (q contient la clé ou vice-versa)
  for (var k in QUARTIER_COORDS) {
    var nk = _normalizeQ(k);
    if (nk.length > 2 && (q.indexOf(nk) !== -1 || nk.indexOf(q) !== -1))
      return QUARTIER_COORDS[k];
  }
  // Essayer via ZONE_MAP_DEFS
  for (var i = 0; i < ZONE_MAP_DEFS.length; i++) {
    var z = ZONE_MAP_DEFS[i];
    var nz = _normalizeQ(z.nom);
    if (nz.length > 2 && (q.indexOf(nz) !== -1 || nz.indexOf(q) !== -1))
      return z.center;
  }
  return null;
}

function _getZoneDef(nomZone) {
  if (!nomZone) return null;
  var n = nomZone.toLowerCase().trim();
  for (var i = 0; i < ZONE_MAP_DEFS.length; i++) {
    if (ZONE_MAP_DEFS[i].nom.toLowerCase() === n) return ZONE_MAP_DEFS[i];
  }
  return null;
}

function _sColor(s) {
  return { nouveau: '#E74C3C', assigne: '#E67E22', visite: '#27AE60' }[s] || '#95A5A6';
}

/* ─────────────────────────────────────
   _buildMap(mapId, zoom) — crée une carte Leaflet
   Retourne le mapObj initialisé
───────────────────────────────────── */
function _buildMap(mapId, zoom) {
  var m = L.map(mapId, { zoomControl: true, scrollWheelZoom: true }).setView([34.028, -5.003], zoom || 13);
...
/* ─────────────────────────────────────
   _drawStaticLayers(map) — Église + cercles de zones
   Retourne un tableau de layers pour pouvoir les retirer si besoin
───────────────────────────────────── */
function _drawStaticLayers(map) {
  var layers = [];

  // Cercles zones
  var activeZoneNames = (S.zones && S.zones.length) ? S.zones.map(function(z){ return z.nom; }) : [];
  ZONE_MAP_DEFS.forEach(function(zd) {
    var isActive = activeZoneNames.length === 0 || activeZoneNames.some(function(n){ return n.toLowerCase() === zd.nom.toLowerCase(); });
    var col = zd.color;
    var circle = L.circle(zd.center, {
      radius: zd.radius,
      color: col, weight: 2,
    ...
    circle.bindPopup(
      ...
      '<div style="font-size:13px;font-weight:700;color:' + col + ';">' + zd.icon + ' ' + zd.nom + '</div>' +
      '<div style="font-size:11px;color:#666;margin-top:2px;">Zone d\'évangélisation</div>' +
      '</div>'
    );
    layers.push(circle);

    // Label centré dans le cercle
    var label = L.marker(zd.center, {
      icon: L.divIcon({
        html: '<div style="font-size:10px;font-weight:700;color:' + col + ';white-space:nowrap;text-shadow:0 0 3px #fff,0 0 3px #fff;opacity:.85;">' + zd.nom + '</div>',
  ...
  // Marqueur Église EEM
  CHURCH_POINTS.forEach(function(pt) {
    var ico = L.divIcon({
      html: '<div style="width:40px;height:40px;border-radius:50%;background:' + pt.color + ';border:3px solid #fff;box-shadow:0 3px 12px rgba(0,0,0,0.45);display:flex;align-items:center;justify-content:center;font-size:19px;">' + pt.icon + '</div>',
      className: '', iconSize: [40, 40], iconAnchor: [20, 20]
    });
    var mk = L.marker([pt.lat, pt.lng], { icon: ico, zIndexOffset: 1000 }).addTo(map);
    mk.bindPopup(
      '<div style="padding:4px 2px;">' +
      '<div style="font-size:13px;font-weight:700;color:#7B1111;">⛪ ' + pt.label + '</div>' +
      '<div style="font-size:11px;color:#666;margin-top:2px;">' + pt.desc + '</div>' +
      '</div>'
    );
    layers.push(mk);
  });
...
/* ─────────────────────────────────────
   _updateDynamicMarkers(map, markers, fiches, evs, filters)
   Retourne le nouveau tableau markers
───────────────────────────────────── */
function _updateDynamicMarkers(map, markers, fiches, evs, filters) {
  markers.forEach(function(m) { map.removeLayer(m); });
  markers = [];
  filters = filters || {};

  var fichesF = fiches.filter(function(f) { return !f.deleted; });
  if (filters.zone)   fichesF = fichesF.filter(function(f) { return ((f.equipe||f.quartier||'')).toLowerCase().indexOf(filters.zone.toLowerCase()) !== -1; });
  if (filters.ev)     fichesF = fichesF.filter(function(f) { return f.evangelisteId === filters.ev; });
  if (filters.statut) fichesF = fichesF.filter(function(f) { return f.statut === filters.statut; });

  // Grouper par quartier (exclure ceux sans coords)
  var byQ = {};
  fichesF.forEach(function(f) {
    var q = f.quartier;
    if (!q || q.trim() === '' || q === '—') return;
    if (!byQ[q]) byQ[q] = [];
    byQ[q].push(f);
  });

  // Clusters quartier
  Object.keys(byQ).forEach(function(quartier) {
    var qFiches = byQ[quartier];
    var coords = _qCoords(quartier);
    if (!coords) return;

    var sc = {};
    qFiches.forEach(function(f) { var s = f.statut||'nouveau'; sc[s]=(sc[s]||0)+1; });
    var dom = Object.keys(sc).sort(function(a,b){ return sc[b]-sc[a]; })[0]||'nouveau';
    var color = _sColor(dom);
    var count = qFiches.length;

    var rows = qFiches.slice(0,6).map(function(f){
      var sc2={nouveau:'#E74C3C',assigne:'#E67E22',visite:'#27AE60'};
      var sl={nouveau:'Non confiée',assigne:'En cours',visite:'Visitée'};
      return '<div style="padding:4px 0;border-bottom:1px solid #eee;font-size:11px;"><strong>'+(f.nom||'')+(f.prenom?' '+f.prenom:'')+'</strong><span style="float:right;font-size:10px;color:'+(sc2[f.statut]||'#999')+'">'+(sl[f.statut]||f.statut||'')+'</span>'+(f.evangelisteNom?'<div style="color:#888;font-size:10px;">👤 '+f.evangelisteNom+'</div>':'')+'</div>';
    }).join('');
    var more = qFiches.length>6?'<div style="font-size:10px;color:#999;text-align:center;margin-top:3px;">+'+(qFiches.length-6)+' autres…</div>':'';
    var popup = '<div style="max-width:230px;padding:2px 0;"><div style="font-size:13px;font-weight:700;margin-bottom:5px;">📍 '+quartier+'</div><div style="font-size:11px;color:#666;margin-bottom:5px;">'+count+' fiche'+(count>1?'s':'')+'</div>'+rows+more+'</div>';

    var ico = L.divIcon({
      html: '<div style="min-width:30px;height:30px;border-radius:15px;background:'+color+';border:2.5px solid #fff;box-shadow:0 2px 8px rgba(0,0,0,0.4);display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:800;color:#fff;padding:0 7px;">'+count+'</div>',
      className:'', iconSize:null, iconAnchor:[15,15]
    });
    var mk = L.marker(coords,{icon:ico}).addTo(map).bindPopup(popup);
    markers.push(mk);
  });

  // Marqueurs évangélistes
  if (!filters.statut) {
    evs.filter(function(ev){ return !filters.ev||ev.id===filters.ev; }).forEach(function(ev) {
      // Utiliser ZONE_MAP_DEFS en priorité pour positionner proprement
      var zdef = _getZoneDef(ev.equipe);
      var coords;
      if (zdef) {
        // Décaler légèrement pour ne pas superposer le label de zone
        coords = [zdef.center[0] + 0.002, zdef.center[1] + 0.002];
      } else {
        coords = _qCoords(ev.equipe||ev.quartier);
      }
      if (!coords) return;

      var init=(ev.nom||'?').split(' ').map(function(w){return w[0];}).join('').slice(0,2).toUpperCase();
      var zcolor = zdef ? zdef.color : '#3498DB';
      var ico = L.divIcon({
        html: '<div style="width:30px;height:30px;border-radius:50%;background:'+zcolor+';border:2.5px solid #fff;box-shadow:0 2px 8px rgba(0,0,0,0.35);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;color:#fff;">'+init+'</div>',
        className:'', iconSize:[30,30], iconAnchor:[15,15]
      });
      var nf=(S.fiches||[]).filter(function(f){return f.evangelisteId===ev.id&&!f.deleted;}).length;
      var mk = L.marker(coords,{icon:ico,zIndexOffset:500}).addTo(map)
        .bindPopup('<div style="padding:2px 0;"><strong style="font-size:12px;">👤 '+ev.nom+'</strong><br><span style="font-size:11px;color:'+zcolor+';">Zone : '+(ev.equipe||'—')+'</span><br><span style="font-size:11px;color:#666;">'+nf+' fiche'+(nf!==1?'s':'')+'</span></div>');
      markers.push(mk);
    });
  }

  return { markers: markers, byQ: byQ, fichesF: fichesF };
}

/* ═══════════════════════════════════════════
   GRANDE CARTE (onglet Cartographie)
═══════════════════════════════════════════ */
var cartoMap = null;
var cartoMarkers = [];
var cartoStaticLayers = [];
var cartoInitialized = false;

function initCarto() {
  if (cartoInitialized) { updateCartoMap(); setTimeout(function(){ if(cartoMap) cartoMap.invalidateSize(); }, 50); return; }
  var el = document.getElementById('carto-map');
  if (!el) return;
  // Rendre le conteneur temporairement visible pour que Leaflet calcule les dimensions
  var tab = document.getElementById('tab-cartographie');
  var wasHidden = tab && tab.style.display === 'none' || (tab && !tab.classList.contains('on'));
  if (tab && wasHidden) {
  ...
  el.style.width = '100%';
  setTimeout(function() {
    cartoMap = _buildMap('carto-map', 13);
    cartoStaticLayers = _drawStaticLayers(cartoMap);
    cartoInitialized = true;
    // Restaurer le tab
    if (tab && wasHidden) {
    ...
    if (S.fiches && S.fiches.length) updateCartoMap();
    setTimeout(function(){ if(cartoMap) { cartoMap.invalidateSize(); if(S.fiches&&S.fiches.length) updateCartoMap(); } }, 200);
    setTimeout(function(){ if(cartoMap) cartoMap.invalidateSize(); }, 600);
  }, 50);
}

/* ═══════════════════════════════════════════
   MINI-CARTE (onglet Zones)
═══════════════════════════════════════════ */
var zoneMap = null;
var zoneMapMarkers = [];
var zoneMapStaticLayers = [];
var zoneMapInitialized = false;

function initZoneMap() {
  if (zoneMapInitialized) { updateZoneMap(); setTimeout(function(){ if(zoneMap) zoneMap.invalidateSize(); }, 50); return; }
  var el = document.getElementById('zone-mini-map');
  if (!el) return;
  var tab = document.getElementById('tab-equipes');
  var wasHidden = tab && (!tab.classList.contains('on') || tab.style.display === 'none');
  if (tab && wasHidden) {
    tab.style.visibility = 'hidden';
    tab.style.display = 'block';
    tab.style.position = 'absolute';
  ...
  el.style.width = '100%';
  setTimeout(function() {
    zoneMap = _buildMap('zone-mini-map', 13);
    zoneMapStaticLayers = _drawStaticLayers(zoneMap);
    ...
    if (S.fiches && S.fiches.length) updateZoneMap();
    setTimeout(function(){ if(zoneMap) { zoneMap.invalidateSize(); if(S.fiches&&S.fiches.length) updateZoneMap(); } }, 200);
    setTimeout(function(){ if(zoneMap) zoneMap.invalidateSize(); }, 600);
  }, 50);
}

function updateZoneMap() {
  if (!zoneMapInitialized || !zoneMap) return;
  var fiches = getFiches();
  var evs = (S.evs||[]).filter(function(e){ return e.actif; });
  var res = _updateDynamicMarkers(zoneMap, zoneMapMarkers, fiches, evs, {});
  zoneMapMarkers = res.markers;
  // Invalidate pour forcer le rendu si la carte était cachée
  setTimeout(function(){ if(zoneMap) zoneMap.invalidateSize(); }, 150);
}

function updateCartoMap() {
  if (!cartoInitialized || !cartoMap) return;

  var fiches = getFiches();
  var evs = (S.evs||[]).filter(function(e){ return e.actif; });
  var filterZone   = (document.getElementById('carto-filter-zone')  ||{}).value||'';
  var filterEv     = (document.getElementById('carto-filter-ev')    ||{}).value||'';
  var filterStatut = (document.getElementById('carto-filter-statut')||{}).value||'';

  var res = _updateDynamicMarkers(cartoMap, cartoMarkers, fiches, evs,
    { zone: filterZone, ev: filterEv, statut: filterStatut });
  cartoMarkers = res.markers;
  var byQ = res.byQ;
  var fichesF = res.fichesF;

  // KPI
  var qSet = new Set(fichesF.map(function(f){ return f.quartier||''; }).filter(function(q){ return q&&q!=='—'; }));
  var evSet = new Set(fichesF.map(function(f){ return f.evangelisteId; }).filter(Boolean));
  document.getElementById('carto-nb-fiches').textContent    = fichesF.length;
  document.getElementById('carto-nb-quartiers').textContent = qSet.size;
  document.getElementById('carto-nb-ev').textContent        = evSet.size;
  document.getElementById('carto-nb-zones').textContent     = (S.zones||[]).length || ZONE_MAP_DEFS.length;
  var lbl = document.getElementById('carto-total-label');
  if (lbl) lbl.textContent = fichesF.length+' fiche'+(fichesF.length!==1?'s':'');

  // Tableau quartiers
  var qEntries = Object.keys(byQ).map(function(q){ return [q, byQ[q]]; }).sort(function(a,b){ return b[1].length-a[1].length; });
  var qList = document.getElementById('carto-quartier-list');
  if (qList) {
    if (!qEntries.length) {
      qList.innerHTML = '<div class="empty-state"><div class="ico">\u{1F4CD}</div><p>Aucune donnée</p></div>';
    } else {
      qList.innerHTML = qEntries.map(function(e) {
        var q=e[0]; var fs=e[1];
        var nv=fs.filter(function(f){return f.statut==='nouveau';}).length;
        var as=fs.filter(function(f){return f.statut==='assigne';}).length;
        var vi=fs.filter(function(f){return f.statut==='visite';}).length;
        var pct=fs.length?Math.round(vi/fs.length*100):0;
        return '<div style="padding:11px 16px;border-bottom:1px solid var(--bo);display:flex;align-items:center;gap:12px;">'+
               '<div style="flex:1;min-width:0;"><div style="font-size:13px;font-weight:700;color:var(--tx);">📍 '+q+'</div>'+
               '<div style="display:flex;gap:8px;margin-top:4px;flex-wrap:wrap;">'+
               '<span style="font-size:10px;color:#E74C3C;font-weight:600;">'+nv+' non confiée'+(nv>1?'s':'')+'</span>'+
               '<span style="font-size:10px;color:#E67E22;font-weight:600;">'+as+' en cours</span>'+
               '<span style="font-size:10px;color:#27AE60;font-weight:600;">'+vi+' visitée'+(vi>1?'s':'')+'</span></div>'+
               '<div style="margin-top:5px;height:4px;background:var(--bg2);border-radius:2px;overflow:hidden;">'+
               '<div style="height:100%;width:'+pct+'%;background:#27AE60;border-radius:2px;"></div></div></div>'+
               '<div style="font-family:'Cormorant Garamond',serif;font-size:24px;font-weight:700;color:var(--c1);flex-shrink:0;">'+fs.length+'</div></div>';
      }).join('');
    }
  }

  // Tableau évangélistes
  var evList = document.getElementById('carto-ev-list');
  if (evList) {
    var evRows = evs.map(function(ev){
      var fEv=fichesF.filter(function(f){ return f.evangelisteId===ev.id; });
      var vi=fEv.filter(function(f){ return f.statut==='visite'; }).length;
      return {ev:ev,fEv:fEv,vi:vi};
    }).filter(function(r){ return r.fEv.length>0; }).sort(function(a,b){ return b.fEv.length-a.fEv.length; });
    if (!evRows.length) {
      evList.innerHTML = '<div class="empty-state"><div class="ico">👤</div><p>Aucun évangéliste avec des fiches</p></div>';
    } else {
      evList.innerHTML = evRows.map(function(r){
        var ev=r.ev; var fEv=r.fEv; var vi=r.vi;
        var pct=fEv.length?Math.round(vi/fEv.length*100):0;
        var init=(ev.nom||'?').split(' ').map(function(w){return w[0];}).join('').slice(0,2).toUpperCase();
        var zd=_getZoneDef(ev.equipe); var zcol=zd?zd.color:'var(--c1)';
        return '<div style="padding:11px 16px;border-bottom:1px solid var(--bo);display:flex;align-items:center;gap:12px;">'+
               '<div style="width:34px;height:34px;border-radius:50%;background:'+zcol+';color:#fff;display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;flex-shrink:0;">'+init+'</div>'+
               '<div style="flex:1;min-width:0;"><div style="font-size:13px;font-weight:700;color:var(--tx);">'+ev.nom+'</div>'+
               '<div style="font-size:11px;color:var(--mu);">'+(ev.equipe||'—')+' · '+fEv.length+' fiche'+(fEv.length!==1?'s':'')+'</div>'+
               '<div style="margin-top:5px;height:4px;background:var(--bg2);border-radius:2px;overflow:hidden;">'+
               '<div style="height:100%;width:'+pct+'%;background:'+zcol+';border-radius:2px;opacity:.8;"></div></div></div>'+
               '<div style="text-align:right;flex-shrink:0;"><div style="font-size:13px;font-weight:700;color:var(--ok);">'+pct+'%</div>'+
               '<div style="font-size:10px;color:var(--mu);">'+vi+' visitée'+(vi!==1?'s':'')+'</div></div></div>';
      }).join('');
    }
  }
  _fillCartoFilters(evs);
}

function _fillCartoFilters(evs) {
  var zoneEl = document.getElementById('carto-filter-zone');
  var evEl   = document.getElementById('carto-filter-ev');
  if (zoneEl) {
    var cur = zoneEl.value;
    zoneEl.innerHTML = '<option value="">Toutes les zones</option>';
    (S.zones||[]).forEach(function(z){
      var o=document.createElement('option'); o.value=z.nom; o.textContent=z.nom; zoneEl.appendChild(o);
    });
    zoneEl.value = cur;
  }
  if (evEl) {
    var curEv = evEl.value;
    evEl.innerHTML = '<option value="">Tous les évangélistes</option>';
    evs.forEach(function(ev){
      var o=document.createElement('option'); o.value=ev.id; o.textContent=ev.nom; evEl.appendChild(o);
    });
    evEl.value = curEv;
  }
}
...
function updateStats() {
  ...
  if (typeof cartoInitialized !== 'undefined' && cartoInitialized) updateCartoMap();
}
...
function initZones() {
  ...
  const handleSnap = (snap) => {
    ...
    _applyZoneUI();
    // Sync cartes en temps réel
    if (typeof cartoInitialized !== 'undefined' && cartoInitialized) updateCartoMap();
    if (typeof zoneMapInitialized !== 'undefined' && zoneMapInitialized) updateZoneMap();
  };
...
function switchTab(name, btn) {
  ...
  if (name === 'equipes') { renderEquipes(); renderZoneChips(); initZoneMap(); setTimeout(function(){ if(zoneMap) zoneMap.invalidateSize(); }, 350); setTimeout(function(){ if(zoneMap) zoneMap.invalidateSize(); }, 700); }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Pré-initialiser les cartes Leaflet en arrière-plan (évite le bug display:none)
  setTimeout(function() {
    initCarto();
